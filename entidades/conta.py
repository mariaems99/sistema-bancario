...
class Conta(ABC):
    ...
    # Método abstrato que deve ser implementado pela subclasses
...
class ContaCorrente(Conta):
    """Subclasse que representa contacorrente 
...
# Define a subclasse Poupança
class ContaPoupanca:
    """Subclasse que representa conta poupança"""
